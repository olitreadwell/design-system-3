...
- The `expanded` prop of `Accordion.Section`. Use `defaultExpanded` instead.
...
* Update react-icons dependency ([#2216](https://github.com/Amsterdam/design-system/issues/2216)) ([acdd7d5](https://github.com/Amsterdam/design-system/commit/acdd7d5dddad8aefb3943b25a2b4a855449a8d71))
...
* **Icon**: `size` 'heading-0' and 'heading-6'
* **Pagination**: `nextVisuallyHiddenLabel`, `previousVisuallyHiddenLabel`, `visuallyHiddenLabel` and `visuallyHiddenLabelId`.

Also, the entire **PageHeading** component.
